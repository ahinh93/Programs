...
public class SwingFeaturesFrame extends JFrame  implements ActionListener, ItemListener
{
	...
	public SwingFeaturesFrame()
	{
		...
		comboboxDisplay = new JLabel("Which size do you want?");
	...
	public void actionPerformed(ActionEvent arg0) 
	{
		...
		case "Size options":
			...
			break;
		case "Color chooser":
			Color col = JColorChooser.showDialog(SwingFeaturesFrame.this, "Choose a color", Color.MAGENTA);
		...
		case "Option":
		{
			...
			int retvalue = JOptionPane.showOptionDialog(SwingFeaturesFrame.this, "Please choose number","Options",JOptionPane.YES_OPTION, JOptionPane.INFORMATION_MESSAGE,null,options,"ocho");
