...
public class Manager extends Employee
{
	 ...
	 * @return
	 */
	public void createSchedule(int empID, int shiftNo, double act_start, double act_end, String date, Employee emp, PrintStream ps)
	{
		//int shiftNo, int empNo, int act_start, int act_end, String date)
		
		new Schedule(empID, shiftNo, act_start, act_end, date, emp, ps);
